...
public class MusicScript : MonoBehaviour {
		...
		public void HandleEvent(MusicEvent _event){
				...
				case MusicEvent.DEAD:
						...
						gain_recover_delay = 1;
						sting_source.PlayOneShot(death_sting);
						break;
				case MusicEvent.WON:
						target_global_gain = 0;
						gain_recover_delay = 4;
